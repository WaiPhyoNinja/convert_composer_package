...
class NumberToBurmeseString implements ChangeInterface
{
    public  function burmeseNumber($numberInput)
    {
        $numbers = array(
              "၀" => 0,
              "၁" => 1,
    ...
    public function convertToEnglishNumber($numberInput){
        $numbers_1 = array(
          "၀" => 0,
          "၁" => 1,
          "၂" => 2,
    ...
    public function convertToBurmeseWords($num, $wordType="written")
    {
